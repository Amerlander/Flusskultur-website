// Featured Quote - Updated November 13, 2025
function noop() { }
function run(fn) {
    return fn();
}
...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			t1 = claim_text(div1_nodes, /*name*/ ctx[0]);
		...
		h() {
			attr(div0, "class", "quote svelte-z9l1zk");
			attr(div1, "class", "name");
			attr(div2, "class", "testimonial svelte-z9l1zk");
			attr(div3, "class", "section-container svelte-z9l1zk");
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			if (dirty & /*quote*/ 4 && raw_value !== (raw_value = /*quote*/ ctx[2].html + "")) div0.innerHTML = raw_value;			if (dirty & /*name*/ 1) set_data(t1, /*name*/ ctx[0]);
