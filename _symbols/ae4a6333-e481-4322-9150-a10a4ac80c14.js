// Site Navigation - Updated September 10, 2024
function noop() { }
const identity = x => x;
...
function create_each_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "link svelte-14x0trs");
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(button, "class", "svelte-14x0trs");
			attr(nav, "id", "popup");
			attr(nav, "class", "svelte-14x0trs");
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(a0, "href", "/");
			attr(a0, "class", "logo svelte-14x0trs");
			attr(nav, "class", "svelte-14x0trs");
			attr(div0, "class", "desktop-nav svelte-14x0trs");
			attr(a1, "href", "/");
			attr(a1, "class", "logo svelte-14x0trs");
			attr(button, "id", "open");
			attr(button, "aria-label", "Open mobile navigation");
			attr(div1, "class", "mobile-nav svelte-14x0trs");
			attr(header, "class", "section-container svelte-14x0trs");
		},
		m(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('logo_svg' in $$props) $$invalidate(4, logo_svg = $$props.logo_svg);
		if ('site_nav' in $$props) $$invalidate(1, site_nav = $$props.site_nav);
	};

	return [logo, site_nav, mobileNavOpen, props, logo_svg, click_handler, click_handler_1];
}
