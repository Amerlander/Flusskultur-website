// Social Links EMAIL Geschützt - Updated November 17, 2025
function noop() { }
...
function create_if_block_1(ctx) {
	...
	return {
		c() {
			div = element("div");
			t = text("Email Anzeigen");
		},
		l(nodes) {
			div = claim_element(nodes, "DIV", {});
			var div_nodes = children(div);
			t = claim_text(div_nodes, "Email Anzeigen");
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = listen(div, "mouseenter", /*revealEmail*/ ctx[4]);
				mounted = true;
			}
		},
		p: noop,
...
function create_if_block(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			t = claim_text(a_nodes, /*email*/ ctx[3]);
		...
		p(ctx, dirty) {
			if (dirty & /*email*/ 8) set_data(t, /*email*/ ctx[3]);
...
// (103:6) {#each social as {link, icon}}
function create_each_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			const icon_changes = {};
			if (dirty & /*social*/ 1) icon_changes.icon = /*icon*/ ctx[7];
...
function instance($$self, $$props, $$invalidate) {
	...
	function revealEmail() {
		// setTimeout(() => {
		$$invalidate(3, email = decode(atob(encoded)));
