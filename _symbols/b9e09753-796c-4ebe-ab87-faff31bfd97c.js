// Site Footer - Updated November 13, 2025
function noop() { }
...
function create_else_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*social_links*/ 1 && t_value !== (t_value = /*link*/ ctx[4].label + "")) set_data(t, t_value);
		},
		i: noop,
		o: noop,
		d(detaching) {
...
// (69:8) {#each social_links as {link, icon}}
...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			t4 = claim_text(span1_nodes, "Flusskultur e. V.");
		...
		h() {
			attr(hr, "class", "svelte-zb2kqc");
			attr(span0, "class", "copyright svelte-zb2kqc");
			attr(span1, "class", "primo svelte-zb2kqc");
			attr(ul, "class", "svelte-zb2kqc");
			attr(div0, "class", "footer svelte-zb2kqc");
			attr(div1, "class", "section-container svelte-zb2kqc");
		},
		m(target, anchor) {
